...
### `Faker\Provider\Lorem`
    ...
    question($nbWords = 6, $variableNbWords = true)  // 'Sit vitae voluptas sint non voluptates?'
    sentence($nbWords = 6, $variableNbWords = true, $terminator = '.')  // 'Sit vitae voluptas sint non voluptates.'
